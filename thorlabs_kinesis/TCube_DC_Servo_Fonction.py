...
class TCubeDCServoFonction():
    """Fonctions pour contrôle du TCube
    """
    ...
    def can_home(self):
        ...
        return self.TCube.CC_CanHome(self.serial)
    ...
    def can_move_without_homing_first(self):
        ...
        return self.TCube.CC_CanMoveWithoutHomingFirst(self.serial)
    ...
    def check_connection(self):
        ...
        return self.TCube.CC_CheckConnection(self.serial)

    def clear_message_queue(self):
        """Clears the device message queue."""
        self.TCube.CC_ClearMessageQueue(self.serial)

    def close(self):
        """Disconnect and close the device."""
        self.TCube.CC_Close(self.serial)

    def disable_channel(self):
        """Disable the channel so that motor can be moved by hand.
        When disabled, power is removed from the motor and it can be freely moved.       """
        self.TCube.CC_DisableChannel(self.serial)

    def enable_channel(self):
        """Enable channel for computer control.
        When enabled, power is applied to the motor so it is fixed in position.        """
        self.TCube.CC_EnableChannel(self.serial)
    ...
    def enable_last_msg_timer(self, enable, last_msg_timeout):
        ...
        self.TCube.CC_EnableLastMsgTimer(self.serial, enable, last_msg_timeout)
    ...
    def get_backlash(self):
        ...
        return self.TCube.CC_GetBacklash(self.serial)
    ...
    def get_encoder_counter(self):
        ...
        return self.TCube.CC_GetEncoderCounter(self.serial)
    ...
    def get_hardware_info(self):
        ...
        return self.TCube.CC_GetHardwareInfo
    ...
    def get_hardware_info_block(self):
        ...
        :class:`.structs.TLI_HardwareInformation`
            The hardware information.        """
        info = TCube.TLI_HardwareInformation()
        self.TCube.CC_GetHardwareInfoBlock(self.serial, byref(info))
        return info
    ...
    def get_homing_params_block(self):
        ...
        params = TCube.MOT_HomingParameters()
        self.TCube.CC_GetHomingParamsBlock(self.serial, byref(params))
        return params
    ...
    def get_homing_velocity(self):
        ...
        return self.TCube.CC_GetHomingVelocity(self.serial)
    ...
    def get_jog_mode(self):
        ...
        mode = c_short()
        stop_mode = c_short()
        self.TCube.CC_GetJogMode(self.serial, byref(mode), byref(stop_mode))
        return TCube.MOT_JogModes(mode.value), TCube.MOT_StopModes(stop_mode.value)
    ...
    def get_jog_params_block(self):
        ...
        :class:`.structs.MOT_JogParameters`
            The jog parameters.        """
        params = TCube.MOT_JogParameters()
        self.TCube.CC_GetJogParamsBlock(self.serial, byref(params))
        return params
    ...
    def get_jog_step_size(self):
        ...
        return self.TCube.CC_GetJogStepSize(self.serial)
    ...
    def get_jog_vel_params(self):
        ...
        acceleration = c_int()
        max_velocity = c_int()
        self.TCube.CC_GetJogVelParams(self.serial, byref(acceleration), byref(max_velocity))
    ...
    def get_led_switches(self):
        ...
        return self.TCube.CC_GetLEDswitches(self.serial)
    ...
    def get_limit_switch_params(self):
        ...
        ccw_pos = c_uint()
        soft = c_word()
        self.TCube.CC_GetLimitSwitchParams(self.serial, byref(cw_lim), byref(ccw_lim),
                                           byref(cw_pos), byref(ccw_pos), byref(soft))
        try:
            cw_mode = TCube.MOT_LimitSwitchModes(cw_lim.value)
        except ValueError:
            cw_mode = TCube.MOT_LimitSwitchModes(cw_lim.value | 0x0080)
        try:
            ccw_mode = TCube.MOT_LimitSwitchModes(ccw_lim.value)
        except ValueError:
            ccw_mode = TCube.MOT_LimitSwitchModes(ccw_lim.value | 0x0080)
        try:
            s_mode = TCube.MOT_LimitSwitchSWModes(soft.value)
        except ValueError:
            s_mode = TCube.MOT_LimitSwitchSWModes(soft.value | 0x0080)
    ...
    def get_limit_switch_params_block(self):
        ...
        """
        params = TCube.MOT_LimitSwitchParameters()
        self.TCube.CC_GetLimitSwitchParamsBlock(self.serial, byref(params))
        return params
    ...
    def get_motor_params_ext(self):
        ...
        pitch = c_double()
        self.TCube.CC_GetMotorParamsExt(self.serial, byref(steps_per_rev),
    ...
    def get_motor_travel_limits(self):
        ...
        self.TCube.CC_GetMotorTravelLimits(self.serial, byref(min_position),
                                           byref(max_position))
    ...
    def get_motor_travel_mode(self):
        ...
        :class:`.enums.MOT_TravelModes`
            The travel mode.
        """
        return TCube.MOT_TravelModes(self.TCube.CC_GetMotorTravelMode(self.serial))
    ...
    def get_motor_velocity_limits(self):
        ...
        self.TCube.CC_GetMotorVelocityLimits(self.serial, byref(max_velocity),
    ...
    def get_move_absolute_position(self):
        ...
        """
        return self.TCube.CC_GetMoveAbsolutePosition(self.serial)
    ...
    def get_move_relative_distance(self):
        ...
        """
        return self.TCube.CC_GetMoveRelativeDistance(self.serial)
    ...
    def get_next_message(self):
        ...
        self.TCube.CC_GetNextMessage(self.serial, byref(message_type),
    ...
    def get_number_positions(self):
        ...
        """
        return self.TCube.CC_GetNumberPositions(self.serial)
    ...
    def get_position(self):
        ...
        """
        return self.TCube.CC_GetPosition(self.serial)
    ...
    def get_position_counter(self):
        ...
        """
        return self.TCube.CC_GetPositionCounter(self.serial)
    ...
    def get_soft_limit_mode(self):
        ...
        """
        return TCube.MOT_LimitsSoftwareApproachPolicy(self.TCube.CC_GetSoftLimitMode(self.serial))
    ...
    def get_software_version(self):
        ...
        """
        return self.TCube.CC_GetSoftwareVersion(self.serial)
    ...
    def get_stage_axis_max_pos(self):
        ...
        """
        return self.TCube.CC_GetStageAxisMaxPos(self.serial)
    ...
    def get_stage_axis_min_pos(self):
        ...
        """
        return self.TCube.CC_GetStageAxisMinPos(self.serial)
    ...
    def get_status_bits(self):
        ...
        """
        return self.TCube.CC_GetStatusBits(self.serial)
    ...
    def get_vel_params(self):
        ...
        acceleration = c_int()
        max_velocity = c_int()
        self.TCube.CC_GetVelParams(self.serial, byref(acceleration), byref(max_velocity))
        return max_velocity.value, acceleration.value
    ...
    def get_vel_params_block(self):
        ...
        """
        params = TCube.MOT_VelocityParameters()
        self.TCube.CC_GetVelParamsBlock(self.serial, byref(params))
        return params
    ...
    def has_last_msg_timer_overrun(self):
        ...
        """
        return self.TCube.CC_HasLastMsgTimerOverrun(self.serial)
    ...
    def home(self):
        ...
        the home position.
        """
        return self.TCube.CC_Home(self.serial)

    def identify(self):
        """Sends a command to the device to make it identify itself."""
        self.TCube.CC_Identify(self.serial)
    ...
    def load_settings(self):
        ...
        """
        self.TCube.CC_LoadSettings(self.serial)
    ...
    def load_named_settings(self, settings_name):
        ...
        settings_name : :class:`str`
            ...
            gets created when the Kinesis software is installed.
        """
        self.TCube.CC_LoadNamedSettings(self.serial, settings_name.encode())
    ...
    def message_queue_size(self):
        ...
        """
        return self.TCube.CC_MessageQueueSize(self.serial)

    def move_absolute(self):
        """Moves the device to the position defined in :meth:`set_move_absolute_position`.
        """
        self.TCube.CC_MoveAbsolute(self.serial)
    ...
    def move_at_velocity(self, direction):
        ...
        """
        self.TCube.CC_MoveAtVelocity(self.serial, direction)
    ...
    def move_to_position(self, index):
        ...
        index : :class:`int`
            The position in ``DeviceUnits`` (see manual).
        """
        self.TCube.CC_MoveToPosition(self.serial, index)
    ...
    def open(self):
        ...
        """
        return self.TCube.CC_Open(self.serial)

    def persist_settings(self):
        """Persist the devices current settings.
        """
        self.TCube.CC_PersistSettings(self.serial)
    ...
    def polling_duration(self):
        ...
        """
        return self.TCube.CC_PollingDuration(self.serial)
    ...
    def request_position(self):
        ...
        """
        self.TCube.CC_RequestPosition(self.serial)
    ...
    def request_settings(self):
        ...
        DLL.
        """
        self.TCube.CC_RequestSettings(self.serial)
    ...
    def set_backlash(self, distance):
        ...
        distance : :class:`int`
            The backlash distance in ``DeviceUnits`` (see manual).
        """
        self.TCube.CC_SetBacklash(self.serial, distance)
    ...
    def set_direction(self, reverse):
        ...
        """
        self.TCube.CC_SetDirection(self.serial, reverse)
    ...
    def set_homing_velocity(self, velocity):
        ...
        velocity : :class:`int`
            The homing velocity in ``DeviceUnits`` (see manual).
        """
        self.TCube.CC_SetHomingVelocity(self.serial, velocity)
    ...
    def set_jog_step_size(self, step_size):
        ...
        step_size : :class:`int`
            The step size in ``DeviceUnits`` (see manual)
        """
        self.TCube.CC_SetJogStepSize(self.serial, step_size)
    ...
    def set_jog_vel_params(self, max_velocity, acceleration):
        ...
        acceleration : :class:`int`
            The acceleration in ``DeviceUnits`` (see manual).
        """
        self.TCube.CC_SetJogVelParams(self.serial, acceleration, max_velocity)
    ...
    def set_led_switches(self, led_switches):
        ...
        ~msl.equipment.exceptions.ThorlabsError
            If not successful.
        """
        self.TCube.CC_SetLEDswitches(self.serial, led_switches)
    ...
    def set_motor_params_ext(self, steps_per_rev, gear_box_ratio, pitch):
        ...
        ~msl.equipment.exceptions.ThorlabsError
            If not successful.
        """
        self.TCube.CC_SetMotorParamsExt(self.serial, steps_per_rev, gear_box_ratio, pitch)
    ...
    def set_motor_travel_limits(self, min_position, max_position):
        ...
        ~msl.equipment.exceptions.ThorlabsError
            If not successful.
        """
        self.TCube.CC_SetMotorTravelLimits(self.serial, min_position, max_position)
    ...
    def set_motor_velocity_limits(self, max_velocity, max_acceleration):
        ...
        ~msl.equipment.exceptions.ThorlabsError
            If not successful.
        """
        self.TCube.CC_SetMotorVelocityLimits(self.serial, max_velocity, max_acceleration)
    ...
    def set_move_absolute_position(self, position):
        ...
        ~msl.equipment.exceptions.ThorlabsError
            If not successful.
        """
        self.TCube.CC_SetMoveAbsolutePosition(self.serial, position)
    ...
    def set_move_relative_distance(self, distance):
        ...
        ~msl.equipment.exceptions.ThorlabsError
            If not successful.
        """
        self.TCube.CC_SetMoveRelativeDistance(self.serial, distance)
    ...
    def set_position_counter(self, count):
        ...
        count : :class:`int`
            The position counter in ``DeviceUnits`` (see manual).
        """
        self.TCube.CC_SetPositionCounter(self.serial, count)
    ...
    def set_stage_axis_limits(self, min_position, max_position):
        ...
        max_position : :class:`int`
            The maximum position in ``DeviceUnits`` (see manual).
        """
        self.TCube.CC_SetStageAxisLimits(self.serial, min_position, max_position)
    ...
    def set_vel_params(self, max_velocity, acceleration):
        ...
        acceleration : :class:`int`
            The acceleration in ``DeviceUnits`` (see manual).
        """
        self.TCube.CC_SetVelParams(self.serial, acceleration, max_velocity)
    ...
    def set_vel_params_block(self, min_velocity, max_velocity, acceleration):
        ...
        self.TCube.CC_SetVelParamsBlock(self.serial, byref(params))
    ...
    def suspend_move_messages(self):
        ...
        """
        self.TCube.CC_SuspendMoveMessages(self.serial)
    ...
    def wait_for_message(self):
        ...
        message_id = c_word()
        message_data = c_word()
        self.TCube.CC_WaitForMessage(self.serial, byref(message_type), byref(message_id), byref(message_data))
        return message_type.value, message_id.value, message_data.value

    def TLI_BuildDeviceList(self):
        """Sends a command to the device to make it identify itself."""
        self.TCube.TLI_BuildDeviceList()
