"Bindings for Thorlabs KCube DC Servo Motor DLL"
# flake8: noqa
from ctypes import (
    Structure,
    cdll,
...
os.environ['PATH'] = 'C:\Program Files\Thorlabs' + os.pathsep + os.environ['PATH']
...
CC_LoadNamedSettings = bind(lib, "CC_LoadNamedSettings", [POINTER(c_char), POINTER(c_char)])
